...
import { Container, TitleContainer, BigTitle, SmallTitle, SearchContainer, LocateInputContainer, LocateInput, DateInputContainer, DateInput, BtnSearch, BtnAuthContainer, BtnSignUp, BtnSignIn } from "./styles";
